...
export const EXPECTED_FIXTURE_ROWS = [
  { repo: "virgiliojr94/book-to-skill", starsToday: 1421, starsTotal: 12709, description: "Turn any technical book PDF into a Claude Code skill.", language: "Python" },
  { repo: "pascalorg/editor", starsToday: 1022, starsTotal: 19553, description: "Create and share 3D architectural projects.", language: "TypeScript" },
  { repo: "paperswithbacktest/awesome-systematic-trading", starsToday: 945, starsTotal: 10379, description: "Open-source systematic trading backtest library.", language: "Python" },
  { repo: "affaan-m/ECC", starsToday: 857, starsTotal: 235547, description: "Some repo with no language line below", language: null },
  { repo: "numsy-pkg/release-notes", starsToday: 555, starsTotal: 8401, description: "Changelog for the 2026 release of numsy, version 2.", language: "Go" },
  { repo: "lone-repo/no-desc", starsToday: 89, starsTotal: 1234, description: null, language: "Python" },
];
